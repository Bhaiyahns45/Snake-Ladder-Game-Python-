...
class SnakeLadderGame:
    ...
    def __init__(self):
        ...
        self.screen = pygame.display.set_mode((670, 640), pygame.RESIZABLE)
    ...
    def wait(self):
        ...
        line1 = font.render("Game Start With 1", True, (255, 0, 0), (255, 255, 255))
    ...
    def game_over(player):
        ...
        global GameOver
        font = pygame.font.SysFont('ariel', 52, bold=True)
        line1 = font.render(f"{player} Won!!!", True, (255, 255, 0))
        line2 = font.render("Press ESc to exit ", True, (255, 255, 0))
        line3 = font.render("Press Enter to Restart", True, (255, 255, 0))
        ...
        screen.blit(line2, (180, 480))
        screen.blit(line3, (130, 540))
        pygame.display.flip()
